		...
		$(window).on("load", function() {
			$("button.tabSwitch").on("click", function() {
				if (!$(this).hasClass("back")) {
					let y = $(this).closest("div.tab").find("input[required]").filter(function() {
						return this.value == "";
					});
					if (y.length > 0) {
			...
			$("button.submit").on("click", function() {
				$(".has-error").removeClass("has-error");
				if ($("#step1 input[required]").filter(function() {
						return this.value == "";
					}).length > 0) {
					document.location.hash = "step1";
					$("#step1 input[required]").filter(function() {
						return this.value == "";
					}).addClass("has-error");
					return;
				}
				if ($("#step2 input[required]").filter(function() {
						return this.value == "";
					}).length > 0) {
					document.location.hash = "step2";
					$("#step2 input[required]").filter(function() {
						return this.value == "";
					}).addClass("has-error");
					return;
				}
	...
	<div id="wrap">
		...
		<form id="install_frm" method="post">
			<div id="step1" class="tab">
				...
				<script>
					$("select[name=timezone]").val(jstz.determine().name());
				</script>
				<div class="row">
