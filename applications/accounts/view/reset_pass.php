...
<script>
    ...
    $("#loginCtn form").submit(e => {
        ...
        $.post("/users/forgot1", s, d => {
            ...
            $("#verifyOTP").xmodal(m => {
                m.find(".text-muted small").text(d.method == "email" ? `Type the code we've just sent to your email at ${d.recipient}.` : (d.method == "sms" ? `Type the code we've just sent to your phone at ${d.recipient}.` : "Type the code on your authenticator app."));
                m.on('shown.bs.modal', () => {
