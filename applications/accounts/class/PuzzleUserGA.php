 ...
 * @author Mohammad Ardika Rifqi (Modified for PuzzleOS)
...
class PuzzleUserGA
{
     ...
     * @return string
     */
    public static function createSecret(int $secretLength = 16)
    {
     ...
     * @return string
     */
    public static function getCode(string $secret, int $timeSlice = null)
    {
        if ($timeSlice === null) {
     ...
     * @return bool
     */
    public static function verifyCode(PuzzleUser $user, $code, $discrepancy = 1, $currentTimeSlice = null)
    {
        $secret = $user->totp_tfa;
